...
<body class="bg-gray-50">
  ...
  <main class="ml-64 p-6">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
      ...
      <!-- HR Card -->
      <?php
// Include this above your HTML, along with the other report calculations
...
<div class="card bg-white p-5 shadow">
  ...
  <div class="grid grid-cols-3 gap-4 text-center">
    <div>
      <p class="text-2xl font-bold text-blue-600"><?= number_format($breakfast_total, 2) ?></p>
      <p class="small-stat text-gray-600">Breakfast</p>
    </div>
    <div>
      <p class="text-2xl font-bold text-yellow-600"><?= number_format($lunch_total, 2) ?></p>
      <p class="small-stat text-gray-600">Lunch</p>
    </div>
    <div>
      <p class="text-2xl font-bold text-green-600"><?= number_format($other_expenses_total, 2) ?></p>
  ...
  <p class="mt-4 text-center font-semibold text-gray-700">
