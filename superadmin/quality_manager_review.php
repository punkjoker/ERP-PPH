        ...
        <table class="min-w-full border border-gray-200 text-sm">
          <thead>
            <tr class="bg-gray-100 text-gray-700 uppercase text-xs">
              ...
              <th class="py-2 px-3 border">Inspection Status</th>
                <th class="py-2 px-3 border">Quality Review Status</th>
...
<tr class="hover:bg-gray-50 transition">
  ...
  <td class="py-2 px-3 border"><?= htmlspecialchars($row['batch_number']); ?></td>
  ...
  <td class="py-2 px-3 border"><?= $qc_text; ?></td>
  <td class="py-2 px-3 border"><?= $review_text; ?></td>
